// Chicken static Scramjet service worker.
// No npm/Node build is required. Client assets are pulled from public CDNs.
...
let wispConfig = { wispurl: 'wss://wisp.mercurywork.shop/wisp/' };
self.addEventListener('message', ({ data }) => {
  if (data?.type === 'config' && typeof data.wispurl === 'string') wispConfig.wispurl = data.wispurl;
});
